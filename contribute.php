...
<h6>Thank you for checking out our website.</h6> 
                            <p><b><?php getwebname("titles"); echo" - "; gettagline("titles");?></b></p>
                            <center><h6>
                                Pay Using UPI <img src="assets/img/pay/upi.png" width="20" height="20">
                            </h6></center>
                    <p class="text-center mt-4"><img src="assets/img/pay/upi-all.png" width="40%" height="40%"></p>
                                        <p class="text-center mt-4"><img src="assets/img/pay/phonepe-zuhair.jpg" width="70%" height="70%"></p>
                    </div> 
                </div>
